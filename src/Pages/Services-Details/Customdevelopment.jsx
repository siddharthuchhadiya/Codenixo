    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
          Building tailored software solutions designed around your business 
          needs—flexible, scalable, secure, and optimized for real performance.
        </p>
      </div>
        ...
        <div className="space-y-12 text-gray-300 leading-relaxed order-2 lg:order-1">
          ...
          <section className="bg-[#111111] p-8 rounded-xl border border-gray-800 shadow-xl">
            ...
            <p className="text-gray-300 text-lg">
              We develop fully customized software systems built specifically 
              around your workflow. Each solution is tailored for your business 
              goals, ensuring efficiency, automation, and seamless performance.
            </p>
          </section>
          ...
          <section className="bg-[#111111] p-8 rounded-xl border border-gray-800 shadow-xl">
            ...
            <p className="text-gray-300 text-lg">
              Automate routine tasks, reduce manual workload, and improve 
              productivity with advanced business automation tools, dashboards, 
              task managers, and workflow systems customized for your team.
            </p>
          </section>
          ...
          <section className="bg-[#111111] p-8 rounded-xl border border-gray-800 shadow-xl">
            <h2 className="text-2xl font-semibold text-white mb-4">
              CRM, ERP & Dashboard Development
            </h2>
            <p className="text-gray-300 text-lg">
              We build enterprise-level CRM, ERP, and management dashboards 
              that help you track operations, manage customers, analyze data, 
              and streamline business processes effortlessly.
            </p>
          </section>
          ...
          <section className="bg-[#111111] p-8 rounded-xl border border-gray-800 shadow-xl">
            ...
            <p className="text-gray-300 text-lg">
              Connect your systems with powerful APIs and cloud platforms to 
              improve scalability, security, and real-time data accessibility. 
              We integrate third-party services, cloud storage, payments, and more.
            </p>
          </section>
          ...
          <section className="bg-[#111111] p-8 rounded-xl border border-gray-800 shadow-xl">
            ...
            <ul className="list-disc ml-6 text-lg space-y-3 text-gray-300">
              <li>Custom Admin & Management Panels</li>
              <li>Multi-user Role Based Systems</li>
              <li>Inventory & Billing Software</li>
              <li>Cloud-Based Web Applications</li>
              <li>Third-Party API Integration</li>
              <li>Advanced Database Architecture</li>
              <li>Software Maintenance & Scaling</li>
            </ul>
          </section>
      ...
      "
        ...
        <div className="w-full flex justify-center items-start order-1 lg:order-2">
          <img
            src="/public/assets/custom software.jpg"
