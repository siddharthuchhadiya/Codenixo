    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
          Building modern, high-performance mobile applications for Android and iOS
          with smooth UI, powerful features, and seamless user experiences.
        </p>
      </div>
        ...
        <div className="space-y-12 text-gray-300 leading-relaxed order-2 lg:order-1">
          ...
          <section className="bg-[#111111] p-8 rounded-xl border border-gray-800 shadow-xl">
            ...
            <p className="text-gray-300 text-lg">
              We develop powerful, scalable, and user-friendly mobile applications
              for both Android and iOS platforms using modern frameworks like
              Flutter and React Native to ensure smooth performance and native speed.
            </p>
          </section>
          ...
          <section className="bg-[#111111] p-8 rounded-xl border border-gray-800 shadow-xl">
            ...
            <p className="text-gray-300 text-lg">
              Our mobile UI/UX designs focus on simple navigation, modern layouts,
              clean interfaces, and high readability to ensure a seamless user journey.
            </p>
          </section>
          ...
          <section className="bg-[#111111] p-8 rounded-xl border border-gray-800 shadow-xl">
            ...
            <p className="text-gray-300 text-lg">
              We integrate secure and fast APIs to connect your mobile app with
              backend systems. From authentication to cloud storage, everything is
          ...
          <section className="bg-[#111111] p-8 rounded-xl border border-gray-800 shadow-xl">
            ...
            <p className="text-gray-300 text-lg">
              Whether it's a business app, e-commerce app, booking system, or custom
              mobile tool, we create tailored applications that match your workflow
              and business needs.
            </p>
          </section>
          ...
          <section className="bg-[#111111] p-8 rounded-xl border border-gray-800 shadow-xl">
            <h2 className="text-2xl font-semibold text-white mb-4">
              Additional App Development Services
            </h2>
            ...
            <ul className="list-disc ml-6 text-lg space-y-3 text-gray-300">
              ...
              <li>Business Apps & Automation Tools</li>
              <li>Push Notifications & Real-Time Updates</li>
              <li>App UI Revamp & Performance Optimization</li>
              <li>API Development for Mobile Apps</li>
      ...
      "
        ...
        <div className="w-full flex justify-center items-start order-1 lg:order-2">
          <img
            src="/public/assets/application details.jpg"
