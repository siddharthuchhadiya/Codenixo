    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
          Creating high-performing, fully customized Shopify stores that deliver 
          excellent user experience and maximize your online sales.
        </p>
      </div>
        ...
        <div className="space-y-12 text-gray-300 leading-relaxed order-2 lg:order-1">
          ...
          <section className="bg-[#111111] p-8 rounded-xl border border-gray-800 shadow-xl">
            ...
            <p className="text-gray-300 text-lg">
              We create fully custom Shopify stores tailored to your brand identity. 
              From layout design to product organization, we deliver unique, 
              conversion-focused e-commerce experiences.
            </p>
          </section>
          ...
          <section className="bg-[#111111] p-8 rounded-xl border border-gray-800 shadow-xl">
            ...
            <p className="text-gray-300 text-lg">
              We customize premium Shopify themes (Debut, Dawn, Impulse, Prestige) 
              or build new ones from scratch—ensuring the perfect match for your brand.
            </p>
          </section>
          ...
          <section className="bg-[#111111] p-8 rounded-xl border border-gray-800 shadow-xl">
            ...
            <p className="text-gray-300 text-lg">
              Integrating Shopify apps for payments, marketing, shipping, tracking, 
              subscriptions, reviews, automation, and more to extend your store’s 
              functionality.
            </p>
          </section>
          ...
          <section className="bg-[#111111] p-8 rounded-xl border border-gray-800 shadow-xl">
            ...
            <p className="text-gray-300 text-lg">
              Start your dropshipping business with a complete Shopify setup using 
              top apps like Oberlo, DSers, and Zendrop—professionally optimized for 
              sales and fast performance.
            </p>
          </section>
          ...
          <section className="bg-[#111111] p-8 rounded-xl border border-gray-800 shadow-xl">
            ...
            <ul className="list-disc ml-6 text-lg space-y-3 text-gray-300">
              ...
              <li>Custom Product Page Design</li>
              <li>Sales Funnel Optimization</li>
              <li>SEO & Page Speed Optimization</li>
              <li>Payment Gateway Setup</li>
              <li>Inventory & Order Management Setup</li>
      ...
      "
        ...
        <div className="w-full flex justify-center items-start order-1 lg:order-2">
          <img
            src="/public/assets/ecommerce details.jpg"
