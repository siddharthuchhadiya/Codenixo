    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-300 max-w-3xl mx-auto mb-8">
          Custom WordPress websites, themes, plugins, e-commerce stores, and 
          complete CMS solutions built with speed, security, and flexibility.
        </p>
      </div>
        ...
        <div className="space-y-12 text-gray-300 leading-relaxed order-2 lg:order-1">
          ...
          <section className="bg-[#111111] p-8 rounded-xl border border-gray-800 shadow-xl">
            ...
            <p className="text-gray-300 text-lg">
              We build fully customized WordPress websites tailored to your 
              brand and business needs. From corporate sites to personal 
              portfolios, we design unique layouts with clean and modern UI.
            </p>
          </section>
          ...
          <section className="bg-[#111111] p-8 rounded-xl border border-gray-800 shadow-xl">
            ...
            <p className="text-gray-300 text-lg">
              Whether you need a brand-new custom theme or want to modify an 
              existing one (like Astra, Divi, or Avada), we create responsive, 
              SEO-optimized, and high-performing designs.
            </p>
          </section>
          ...
          <section className="bg-[#111111] p-8 rounded-xl border border-gray-800 shadow-xl">
            ...
            <p className="text-gray-300 text-lg">
              We develop custom plugins, integrate advanced tools, and extend 
              WordPress functionality — including security, automation, payments, 
              forms, and API features.
            </p>
          </section>
          ...
          <section className="bg-[#111111] p-8 rounded-xl border border-gray-800 shadow-xl">
            ...
            <p className="text-gray-300 text-lg">
              We build powerful and conversion-focused e-commerce stores using 
              WooCommerce — product pages, checkout flow, filters, cart systems, 
              and complete online shop management.
            </p>
          </section>
          ...
          <section className="bg-[#111111] p-8 rounded-xl border border-gray-800 shadow-xl">
            ...
            <ul className="list-disc ml-6 text-lg space-y-3 text-gray-300">
              <li>Website Migration & Backup</li>
              <li>Speed Optimization (90+ Google Score)</li>
              <li>Security Enhancement & Firewall Setup</li>
              <li>Bug Fixing & Troubleshooting</li>
              <li>Custom Form & API Integrations</li>
              <li>Website Maintenance & Updates</li>
              <li>SEO Setup & On-Page Optimization</li>
            </ul>
          </section>
      ...
      "
        ...
        <div className="w-full flex justify-center items-start order-1 lg:order-2">
          <img
            src="/public/assets/wordpress details.jpg"
